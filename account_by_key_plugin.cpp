#include <newt/account_by_key/account_by_key_plugin.hpp>
#include <newt/account_by_key/account_by_key_objects.hpp>
...
namespace newt { namespace account_by_key {
...
struct post_operation_visitor
{
   ...
   {
      if( op.hardfork_id == newt_HARDFORK_0_9 )
      {
...
account_by_key_plugin::account_by_key_plugin( newt::app::application* app )
...
newt_DEFINE_PLUGIN( account_by_key, newt::account_by_key::account_by_key_plugin )
