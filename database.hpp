...
#include <newt/chain/hardfork.hpp>
#include <newt/chain/node_property_object.hpp>
#include <newt/chain/fork_database.hpp>
#include <newt/chain/block_log.hpp>
#include <newt/chain/operation_notification.hpp>

#include <newt/protocol/protocol.hpp>
...
namespace newt { namespace chain {
   ...
   using newt::protocol::signed_transaction;
   using newt::protocol::operation;
   ...
   class database : public chainbase::database
   {
      public:
          ...
          */
         void open( const fc::path& data_dir, const fc::path& shared_mem_dir, uint64_t initial_supply = newt_INIT_SUPPLY, uint64_t shared_file_size = 0, uint32_t chainbase_flags = 0 );
          ...
          *
          * Passing slot_num == 0 returns newt_NULL_WITNESS
          */
         ...
         void init_schema();
         void init_genesis(uint64_t initial_supply = newt_INIT_SUPPLY );
   ...
   protected:
      ...
      private:
         ...
         fc::time_point_sec            _hardfork_times[ newt_NUM_HARDFORKS + 1 ];
         protocol::hardfork_version    _hardfork_versions[ newt_NUM_HARDFORKS + 1 ];
