...
namespace newt { namespace chain {
   ...
   using newt::protocol::chain_properties;
   using newt::protocol::digest_type;
   using newt::protocol::public_key_type;
   using newt::protocol::version;
   using newt::protocol::hardfork_version;
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         time_point_sec    hardfork_time_vote = newt_GENESIS_TIME;
   };
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, newt_MAX_WITNESSES >             current_shuffled_witnesses;
         ...
         uint8_t max_voted_witnesses            = newt_MAX_VOTED_WITNESSES_HF0;
         uint8_t max_miner_witnesses            = newt_MAX_MINER_WITNESSES_HF0;
         uint8_t max_runner_witnesses           = newt_MAX_RUNNER_WITNESSES_HF0;
         uint8_t hardfork_required_witnesses    = newt_HARDFORK_REQUIRED_WITNESSES;
   };
...
FC_REFLECT_ENUM( newt::chain::witness_object::witness_schedule_type, (top19)(timeshare)(miner)(none) )

FC_REFLECT( newt::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( newt::chain::witness_object, newt::chain::witness_index )

FC_REFLECT( newt::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( newt::chain::witness_vote_object, newt::chain::witness_vote_index )

FC_REFLECT( newt::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( newt::chain::witness_schedule_object, newt::chain::witness_schedule_index )
