...
namespace newt { namespace chain {
   ...
   using newt::protocol::asset_symbol_type;
...
#include <newt/chain/comment_object.hpp>
#include <newt/chain/account_object.hpp>

FC_REFLECT_ENUM( newt::chain::curve_id,
                  (quadratic)(quadratic_curation)(linear)(square_root))

FC_REFLECT( newt::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( newt::chain::limit_order_object, newt::chain::limit_order_index )

FC_REFLECT( newt::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( newt::chain::feed_history_object, newt::chain::feed_history_index )

FC_REFLECT( newt::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( newt::chain::convert_request_object, newt::chain::convert_request_index )

FC_REFLECT( newt::chain::liquidity_reward_balance_object,
             (id)(owner)(steem_volume)(sbd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( newt::chain::liquidity_reward_balance_object, newt::chain::liquidity_reward_balance_index )

FC_REFLECT( newt::chain::withdraw_vesting_route_object,
             (id)(from_account)(to_account)(percent)(auto_vest) )
CHAINBASE_SET_INDEX_TYPE( newt::chain::withdraw_vesting_route_object, newt::chain::withdraw_vesting_route_index )

FC_REFLECT( newt::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( newt::chain::savings_withdraw_object, newt::chain::savings_withdraw_index )

FC_REFLECT( newt::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (sbd_balance)(steem_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( newt::chain::escrow_object, newt::chain::escrow_index )

FC_REFLECT( newt::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( newt::chain::decline_voting_rights_request_object, newt::chain::decline_voting_rights_request_index )

FC_REFLECT( newt::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( newt::chain::reward_fund_object, newt::chain::reward_fund_index )
