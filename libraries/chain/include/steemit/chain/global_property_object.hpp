...
namespace steemit {
    namespace chain {
        ...
        class dynamic_global_pool_object : public object<dynamic_global_pool_object_type, dynamic_global_pool_object>{
        public:
            template<typename Constructor, typename Allocator>
            dynamic_global_pool_object(Constructor &&c, allocator<Allocator> a) {
                c(*this);
            }

            id_type id;

            int64_t curation_pool;
            int64_t cost_curation;

            int64_t initminer_pool;
            int64_t cost_initminer;
        ...
        typedef multi_index_container<
                dynamic_global_pool_object,
                indexed_by<
                        ordered_unique<tag<by_id>,
                                member<dynamic_global_pool_object, dynamic_global_pool_object::id_type, &dynamic_global_pool_object::id> >
                >,
                allocator<dynamic_global_pool_object>
        > dynamic_global_pool_index;
    }
} // steemit::chain
...
FC_REFLECT(steemit::chain::dynamic_global_pool_object,
           (id)
                   (curation_pool)
                   (cost_curation)
           (initminer_pool)
...
CHAINBASE_SET_INDEX_TYPE(steemit::chain::dynamic_global_pool_object, steemit::chain::dynamic_global_pool_index)
