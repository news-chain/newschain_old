...
namespace steemit {
    namespace chain {
        ...
        enum object_type {
            ...
            dynamic_global_pool_object_type,
            account_object_type,
            ...
            comment_read_object_type, //add 2018.2.26
            comment_share_object_type,
            comment_vote_up_object_type,
            comment_vote_down_object_type,
            account_asset_type,
            asset_symbol_object_type,
            ...
            reward_detail_object_type,
            reward_for_teacher_object_type,
            transfer_history_type,
        };

        class dynamic_global_property_object;
        class dynamic_global_pool_object;

        class account_object;

        class account_asset;

        class asset_symbol_object;
        ...
        class comment_read_object;

        class comment_share_object;

        class comment_vote_up_object;
        class comment_vote_down_object;
        ...
        class reward_detail_object;

        class reward_for_teacher_object;

        class transfer_history;

        typedef oid<dynamic_global_property_object> dynamic_global_property_id_type;
        typedef oid<dynamic_global_pool_object> dynamic_global_pool_id_type;
        typedef oid<account_asset> account_asset_id_type;
        typedef oid<asset_symbol_object> asset_symbol_object_id_type;
        ...
        typedef oid<comment_read_object> comment_read_id_type;//add 2018.2.26 by zhang
        typedef oid<comment_vote_object> comment_vote_id_type;
        typedef oid<comment_share_object> comment_share_id_type;
        typedef oid<comment_vote_up_object> comment_vote_up_id_type;
        typedef oid<comment_vote_down_object> comment_vote_down_id_type;
        ...
        typedef oid<reward_detail_object> reward_detail_id_type;
        typedef oid<reward_for_teacher_object> reward_for_teacher_id_type;
        typedef oid<transfer_history> transfer_history_id_type;
