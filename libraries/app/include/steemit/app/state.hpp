...
namespace steemit {
    namespace app {
        ...
        //add 2018.3.2 by zhang for read or share history
        struct read_history{
            string reader;
            string author;
            string permlink;
            time_point_sec first_time;
        ...
        struct reward_detail_relationship{
            string user;
            string parent;
            string teacher;
        ...
        struct transfer_object{
            ...
            string to;
            int64_t amount;
            asset_symbol_type type;
            time_point_sec created_time;
            string memo;
            int64_t index;

//            bool operator > (const transfer_object &o1){
...
FC_REFLECT_DERIVED(steemit::app::extended_account,
                   ...
                   (vesting_balance)(reputation)
                           (transfer_history)(market_history)(post_history)(vote_history)(other_history)(witness_votes)(
                           tags_usage)(guest_bloggers)(open_orders)(comments)(feed)(blog)(recent_replies)(recommended))
...
FC_REFLECT(steemit::app::discussion_index,
...
FC_REFLECT_DERIVED(steemit::app::discussion, (steemit::app::comment_api_obj),
...
FC_REFLECT(steemit::app::state,
           (current_route)(props)(tag_idx)(tags)(content)(accounts)(pow_queue)(witnesses)(discussion_idx)(
                   witness_schedule)(feed_price)(error)(market_data))
...
//add
FC_REFLECT(steemit::app::read_history, (reader)(author)(permlink)(first_time)(last_time));
FC_REFLECT(steemit::app::share_history, (sharer)(author)(permlink)(first_time)(last_time)(count));
FC_REFLECT(steemit::app::reward_detail_history, (operation)(creator)(amount)(created_time)(weight)(to_user)(index));

FC_REFLECT(steemit::app::other_asset, (tag_name)(creator)(create_time)(symbol)(amount));
FC_REFLECT(steemit::app::simple_other_asset, (amount)(symbol)(name));
FC_REFLECT(steemit::app::reward_detail_relationship, (user)(parent)(teacher)(user_amount)(parent_amount)(teacher_amount)(create_time)(op)(index));
//FC_REFLECT(steemit::app::reward_detail_history, (voter)(author)(permlink)(vote_time)(type));

FC_REFLECT(steemit::app::transfer_object, (from)(to)(amount)(type)(created_time)(memo)(index));
