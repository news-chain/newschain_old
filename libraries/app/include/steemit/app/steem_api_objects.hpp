...
//                level.updateLevel();
            ...
            //add 2018.2.28 by zhang
            account_name_type parentNode;
            userLevel level; //key:read, share, write value:level
        };
...
FC_REFLECT(steemit::app::comment_api_obj,
           (id)(author)(permlink)
                   ...
                   (total_vote_weight)(reward_weight)(total_payout_value)(curator_payout_value)(author_rewards)(
...
FC_REFLECT(steemit::app::account_api_obj,
           (id)(name)(owner)(active)(posting)(memo_key)(json_metadata)(proxy)(last_owner_update)(last_account_update)
                   ...
                   next_vesting_withdrawal)(withdrawn)(to_withdraw)(withdraw_routes)
                   (curation_rewards)
                   (posting_rewards)
                   (proxied_vsf_votes)(witnesses_voted_for)
                   (average_bandwidth)(lifetime_bandwidth)(last_bandwidth_update)
                   (average_market_bandwidth)(lifetime_market_bandwidth)(last_market_bandwidth_update)
                   (last_post)(last_root_post)(parentNode)(level)
)
