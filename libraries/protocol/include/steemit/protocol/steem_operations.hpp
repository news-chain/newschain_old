...
namespace steemit {
    namespace protocol {
        ...
        //add read comment operation by zhang on 2018.2.27
        struct read_comment_operation : public base_operation {
            account_name_type reader;

            account_name_type author;
            string permlink;

            void get_required_posting_authorities(flat_set <account_name_type> &a) const { a.insert(reader); }

            void validate() const;
        };

        struct share_comment_operation : public base_operation{
        ...
        struct chain_properties {
            ...
            asset account_creation_fee =
                    asset(STEEMIT_MIN_ACCOUNT_CREATION_FEE, NEWS_SYMBOL);
        ...
        struct custom_operation : public base_operation {
            ...
            void get_required_active_authorities(
                    flat_set <account_name_type> &a) const { for (const auto &i : required_auths) a.insert(i); }
        };
        ...
        struct custom_json_operation : public base_operation {
            ...
            void get_required_posting_authorities(
                    flat_set <account_name_type> &a) const { for (const auto &i : required_posting_auths) a.insert(i); }
        };
        ...
        struct custom_binary_operation : public base_operation {
            ...
            void get_required_owner_authorities(
                    flat_set <account_name_type> &a) const { for (const auto &i : required_owner_auths) a.insert(i); }

            void get_required_active_authorities(
                    flat_set <account_name_type> &a) const { for (const auto &i : required_active_auths) a.insert(i); }
         ...
         * vote up,
         * */
        struct vote_up_operation : public base_operation{
            account_name_type voter;
            account_name_type author;
            string permlink;
            string extends;
         ...
         * vote down
         * */
        struct vote_down_operation : public base_operation{
            account_name_type voter;
            account_name_type author;
            string permlink;
            string extends;
        ...
        struct transfer_other_asset_operation : public base_operation{
            account_name_type from;
            account_name_type to;
            uint64_t symbol;
            uint64_t amount;
...
FC_REFLECT(steemit::protocol::comment_operation,
           (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata)(extends))
...
FC_REFLECT(steemit::protocol::read_comment_operation, (reader)(author)(permlink));
FC_REFLECT(steemit::protocol::share_comment_operation, (sharer)(author)(permlink));
...
FC_REFLECT(steemit::protocol::vote_up_operation, (voter)(author)(permlink)(extends));
FC_REFLECT(steemit::protocol::vote_down_operation, (voter)(author)(permlink)(extends));
FC_REFLECT(steemit::protocol::create_asset_operation, (creator)(amount)(tag_name)(meta));
FC_REFLECT(steemit::protocol::transfer_other_asset_operation, (from)(to)(symbol)(amount)(memo));
