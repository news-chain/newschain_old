...
{
   public:
      debug_node_api( const newt::app::api_context& ctx );
       ...
       */
      // not implemented
      //void debug_push_block( newt::chain::signed_block& block );
...
FC_REFLECT( newt::plugin::debug_node::get_dev_key_args,
   (name)
   )

FC_REFLECT( newt::plugin::debug_node::get_dev_key_result,
   (private_key)
   (public_key)
   )

FC_REFLECT( newt::plugin::debug_node::debug_mine_args,
   (worker_account)
   (props)
   )

FC_REFLECT( newt::plugin::debug_node::debug_mine_result,
   )

FC_REFLECT( newt::plugin::debug_node::debug_busy_wait_args,
   (microseconds)
   )

FC_REFLECT( newt::plugin::debug_node::debug_busy_wait_result,
   (hash_count)
   )

FC_API(newt::plugin::debug_node::debug_node_api,
       (debug_push_blocks)
