...
#include <newt/witness/witness_objects.hpp>
...
FC_REFLECT( newt::app::comment_api_obj,
             (id)(author)(permlink)
...
FC_REFLECT( newt::app::account_api_obj,
...
FC_REFLECT( newt::app::owner_authority_history_api_obj,
             (id)
             (account)
...
FC_REFLECT( newt::app::account_recovery_request_api_obj,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( newt::app::savings_withdraw_api_obj,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( newt::app::feed_history_api_obj,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( newt::app::tag_api_obj,
            (name)
            (total_payouts)
            (net_votes)
            (top_posts)
...
FC_REFLECT( newt::app::witness_api_obj,
             (id)
             (owner)
             (created)
...
FC_REFLECT_DERIVED( newt::app::signed_block_api_obj, (newt::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT_DERIVED( newt::app::dynamic_global_property_api_obj, (newt::chain::dynamic_global_property_object),
