...
FC_REFLECT( newt::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( newt::account_by_key::key_lookup_object, newt::account_by_key::key_lookup_index )
