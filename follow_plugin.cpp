#include <newt/follow/follow_api.hpp>
#include <newt/follow/follow_objects.hpp>
#include <newt/follow/follow_operations.hpp>

#include <newt/app/impacted.hpp>

#include <newt/protocol/config.hpp>

#include <newt/chain/database.hpp>
#include <newt/chain/index.hpp>
#include <newt/chain/generic_custom_operation_interpreter.hpp>
...
class follow_plugin_impl
{
   public:
      ...
      follow_plugin&                                                                         _self;
      std::shared_ptr< generic_custom_operation_interpreter< newt::follow::follow_plugin_operation > > _custom_operation_interpreter;
};

void follow_plugin_impl::plugin_initialize()
{
   // Each plugin needs its own evaluator registry.
   _custom_operation_interpreter = std::make_shared< generic_custom_operation_interpreter< newt::follow::follow_plugin_operation > >( database() );
...
newt_DEFINE_PLUGIN( follow, newt::follow::follow_plugin )
