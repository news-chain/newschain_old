...
FC_REFLECT( newt::app::network_broadcast_api::transaction_confirmation,
        (id)(block_num)(trx_num)(expired) )
FC_REFLECT( newt::app::steem_version_info, (blockchain_version)(steem_revision)(fc_revision) )
//FC_REFLECT_TYPENAME( fc::ecc::compact_signature );
//FC_REFLECT_TYPENAME( fc::ecc::commitment_type );

FC_API(newt::app::network_broadcast_api,
...
FC_API(newt::app::network_node_api,
       (get_info)
       (add_node)
       (get_connected_peers)
       (get_potential_peers)
