...
#include <newt/follow/follow_plugin.hpp>
...
FC_REFLECT_ENUM( newt::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( newt::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( newt::follow::follow_object, newt::follow::follow_index )

FC_REFLECT( newt::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( newt::follow::feed_object, newt::follow::feed_index )

FC_REFLECT( newt::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( newt::follow::blog_object, newt::follow::blog_index )

FC_REFLECT( newt::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( newt::follow::reputation_object, newt::follow::reputation_index )

FC_REFLECT( newt::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( newt::follow::follow_count_object, newt::follow::follow_count_index )

FC_REFLECT( newt::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( newt::follow::blog_author_stats_object, newt::follow::blog_author_stats_index );
