#include <newt/account_history/account_history_plugin.hpp>
...
#define STEEM_NAMESPACE_PREFIX "newt::protocol::"
...
void account_history_plugin_impl::on_operation( const operation_notification& note )
{
   ...
   newt::chain::database& db = database();
...
newt_DEFINE_PLUGIN( account_history, newt::account_history::account_history_plugin )
