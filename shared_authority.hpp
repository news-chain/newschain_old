...
namespace newt { namespace chain {
   ...
   using newt::protocol::weight_type;
...
FC_REFLECT_TYPENAME( newt::chain::shared_authority::account_authority_map)
FC_REFLECT( newt::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
