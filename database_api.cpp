...
#include <newt/tags/tags_plugin.hpp>

#include <newt/follow/follow_plugin.hpp>
#include <newt/witness/witness_plugin.hpp>
...
{
   public:
      database_api(const newt::app::api_context& ctx);
      ~database_api();
...
FC_REFLECT( newt::app::order, (order_price)(real_price)(steem)(sbd)(created) );
FC_REFLECT( newt::app::order_book, (asks)(bids) );
FC_REFLECT( newt::app::scheduled_hardfork, (hf_version)(live_time) );
FC_REFLECT( newt::app::liquidity_balance, (account)(weight) );
FC_REFLECT( newt::app::withdraw_route, (from_account)(to_account)(percent)(auto_vest) );

FC_REFLECT( newt::app::discussion_query, (tag)(filter_tags)(select_tags)(select_authors)(truncate_body)(start_author)(start_permlink)(parent_author)(parent_permlink)(limit) );

FC_REFLECT_ENUM( newt::app::withdraw_route_type, (incoming)(outgoing)(all) );

FC_REFLECT( newt::app::verify_signatures_args,
   (hash)
   (signatures)
   (required_owner)
   (required_active)
...
FC_REFLECT( newt::app::verify_signatures_return,
   (valid) )

FC_API(newt::app::database_api,
   // Subscriptions
