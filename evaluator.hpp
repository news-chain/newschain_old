...
template< typename OperationType=newt::protocol::operation >
class evaluator
{
   public:
...
template< typename EvaluatorType, typename OperationType=newt::protocol::operation >
...
class X ## _evaluator : public newt::chain::evaluator_impl< X ## _evaluator > \
{                                                                           \
   public:                                                                  \
      typedef X ## _operation operation_type;                               \
                                                                            \
      X ## _evaluator( database& db )                                       \
         : newt::chain::evaluator_impl< X ## _evaluator >( db )          \
      {}                                                                    \
                                                                            \
