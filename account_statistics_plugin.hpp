...
class account_statistics_plugin : public newt::app::plugin
{
   public:
...
FC_REFLECT( newt::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
...
//SET_INDEX_TYPE( newt::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   newt::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
