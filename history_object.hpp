...
FC_REFLECT( newt::chain::operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
CHAINBASE_SET_INDEX_TYPE( newt::chain::operation_object, newt::chain::operation_index )

FC_REFLECT( newt::chain::account_history_object, (id)(account)(sequence)(op) )
CHAINBASE_SET_INDEX_TYPE( newt::chain::account_history_object, newt::chain::account_history_index )
