...
)
{
   ...
   newt::chain::public_key_type debug_public_key;
   if( debug_key != "" )
   {
   ...
   while( produced < count )
   {
      ...
      newt::chain::public_key_type scheduled_key = scheduled_witness.signing_key;
      if( debug_key != "" )
      {
...
newt_DEFINE_PLUGIN( debug_node, newt::plugin::debug_node::debug_node_plugin )
