...
namespace newt { namespace chain {
   ...
   class comment_object : public object < comment_object_type, comment_object >
   {
      ...
      public:
         ...
         uint16_t          percent_steem_dollars = newt_100_PERCENT; /// the percent of Steem Dollars to key, unkept amounts will be received as Steem Power
...
FC_REFLECT( newt::chain::comment_object,
             (id)(author)(permlink)
...
CHAINBASE_SET_INDEX_TYPE( newt::chain::comment_object, newt::chain::comment_index )

FC_REFLECT( newt::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( newt::chain::comment_vote_object, newt::chain::comment_vote_index )
