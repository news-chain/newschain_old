...
namespace newt { namespace chain {
   ...
   class dynamic_global_property_object : public object< dynamic_global_property_object_type, dynamic_global_property_object>
   {
      public:
         ...
         uint16_t sbd_print_rate = newt_100_PERCENT;
...
FC_REFLECT( newt::chain::dynamic_global_property_object,
             (id)
             (head_block_number)
             (head_block_id)
             (time)
...
CHAINBASE_SET_INDEX_TYPE( newt::chain::dynamic_global_property_object, newt::chain::dynamic_global_property_index )
