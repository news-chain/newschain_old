...
#include <newt/protocol/base.hpp>
...
using namespace std;
using newt::protocol::base_operation;
...
FC_REFLECT( newt::follow::follow_operation, (follower)(following)(what) )
FC_REFLECT( newt::follow::reblog_operation, (account)(author)(permlink) )

DECLARE_OPERATION_TYPE( newt::follow::follow_plugin_operation )

FC_REFLECT_TYPENAME( newt::follow::follow_plugin_operation )
